...
def test_string_like():
    ...
    # Make absolutely darn certain that hoatzin's C code never comes into
...
def test_PyInstaller_hook():
    ...
    from hoatzin import _PyInstaller_hook_dir
    hook_dir, = _PyInstaller_hook_dir()
    assert os.path.isdir(hook_dir)
    hook = os.path.join(hook_dir, "hook-hoatzin.py")
