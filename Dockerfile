...
# Build with: (note the -t hoatzin-manylinux1_x86_64 is just an arbitrary name)
#  $ docker build -t hoatzin-manylinux1_x86_64 .
# Or to specify an alternative base (say manylinux1_i686 for 32bit Linux):
#  $ docker build -t hoatzin-manylinux1_i686 --build-arg BASE=manylinux1_i686 .
# Then boot into your new image with:
#  $ docker run -it hoatzin-manylinux1_x86_64
...
#  $ docker run -it hoatzin-manylinux1_x86_64 python
# Or to run pytest:
#  $ docker run -it hoatzin-manylinux1_x86_64 pytest
...
# syncronised use:
#  $ docker run -v `pwd`:/io -it hoatzin-manylinux1_x86_64
